...
const Navigation: React.FC = () => {
  return (
    <nav className="sticky top-0 z-10 bg-white shadow dark:bg-gray-800">
      <div className="container mx-auto flex max-w-screen-xl items-center justify-around p-6 whitespace-nowrap text-gray-600 capitalize max-md:flex-col max-md:gap-6 dark:text-gray-300">
