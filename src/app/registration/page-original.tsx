  ...
  return (
    <main className="flex flex-col items-center">
      <div className="font-serif p-6 mt-4 max-w-screen-md w-full bg-white">
        ...
        <p className="mt-2 mb-4 text-base text-left">
        ...
        <form action={formAction}>
          ...
          <div className="grid sm:grid-cols-[max-content_1fr] gap-y-1 mb-4 sm:gap-y-2">
            ...
            <input type="text" name="nin" placeholder="xxxxxx/xxxx" required />
            <label>Health insurance company:</label>
            <input type="text" name="insurance" placeholder="xxx" required />
          ...
          <div className="grid sm:grid-cols-[max-content_1fr] gap-y-1 mb-4 sm:gap-y-2">
            ...
            <input
              type="text"
              name="lg1_phonenumber"
              placeholder="+XXX XXX XXX XXX"
              required
            />
            <label>E-mail for communication:</label>
            <input
              type="email"
              name="lg1_email"
          ...
          <div className="grid sm:grid-cols-[max-content_1fr] gap-y-1 mb-4 sm:gap-y-2">
            <label>Full name:</label>
            <input type="text" name="lg2_fullname" placeholder="full name" />
            <label>Phone number:</label>
            <input
              type="text"
              name="lg2_phonenumber"
              placeholder="+XXX XXX XXX XXX"
            />
            <label>E-mail for communication:</label>
            <input type="email" name="lg2_email" placeholder="email address" />
          </div>
